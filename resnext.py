...
def ResNext(input_shape=None, depth=29, cardinality=8, width=64, weight_decay=5e-4,
            include_top=None, weights=None, input_tensor=None,
...
def __bottleneck_block(input, filters=64, cardinality=8, strides=1, weight_decay=5e-4):
    ...
    x = squeeze_excitation_layer(x, out_dim=Out_dim)
    # print('bbbbbbbbbbbb.............bbbbbbbbbbbbb', Out_dim)
...
def squeeze_excitation_layer(x, out_dim):
        ...
        excitation = Reshape((out_dim,1,1))(excitation)
